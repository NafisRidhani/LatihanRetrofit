package org.aplas.latihanretrofit.databinding;
import org.aplas.latihanretrofit.R;
import org.aplas.latihanretrofit.BR;
...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.repo == variableId) {
            setRepo((org.aplas.latihanretrofit.models.Repo) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setRepo(@Nullable org.aplas.latihanretrofit.models.Repo Repo) {
        this.mRepo = Repo;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        org.aplas.latihanretrofit.models.Repo repo = mRepo;
